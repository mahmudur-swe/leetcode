...
<div class="top-box hide"><div class="alert-info"></div></div><pre data-original-code="Input: height = [1,8,6,2,5,4,8,3,7]
Output: 49
Explanation: The above vertical lines are represented by array [1,8,6,2,5,4,8,3,7]. In this case, the max area of water (blue section) the container can contain is 49.
" data-snippet-id="ext.2a4622062339e11d688c163ac40ca7a0" data-snippet-saved="false" data-codota-status="done"><strong>Input:</strong> height = [1,8,6,2,5,4,8,3,7]
