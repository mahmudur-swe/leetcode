...
<div class="top-box hide"><div class="alert-info"></div></div><pre data-original-code="Input: root = [1,2,3,4,5]
Output: [[4,5,3],[2],[1]]
Explanation:
[[3,5,4],[2],[1]] and [[3,4,5],[2],[1]] are also considered correct answers since per each level it does not matter the order on which elements are returned.
" data-snippet-id="ext.548733d7299763d23d1a3e4c95d07276" data-snippet-saved="false" data-codota-status="done"><strong>Input:</strong> root = [1,2,3,4,5]
