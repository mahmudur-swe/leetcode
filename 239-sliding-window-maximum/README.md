...
<div class="top-box hide"><div class="alert-info"></div></div><pre data-original-code="Input: nums = [1,3,-1,-3,5,3,6,7], k = 3
Output: [3,3,5,5,6,7]
Explanation: 
Window position                Max
---------------               -----
[1  3  -1] -3  5  3  6  7       3
 ...
 1  3  -1  -3 [5  3  6] 7       6
 1  3  -1  -3  5 [3  6  7]      7
" data-snippet-id="ext.c3541f847822c4f9fd0704b13b970018" data-snippet-saved="false" data-codota-status="done"><strong>Input:</strong> nums = [1,3,-1,-3,5,3,6,7], k = 3
