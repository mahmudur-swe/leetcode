...
<div class="top-box hide"><div class="alert-info"></div></div><pre data-original-code="Input: n = 3, connections = [[1,2,5],[1,3,6],[2,3,1]]
Output: 6
Explanation: Choosing any 2 edges will connect all cities so we choose the minimum 2.
" data-snippet-id="ext.a8a70fee631d003448b5a20895165357" data-snippet-saved="false" data-codota-status="done"><strong>Input:</strong> n = 3, connections = [[1,2,5],[1,3,6],[2,3,1]]
...
<div class="top-box hide"><div class="alert-info"></div></div><pre data-original-code="Input: n = 4, connections = [[1,2,3],[3,4,4]]
Output: -1
Explanation: There is no way to connect all cities even if all edges are used.
" data-snippet-id="ext.6a8ef8efa4cbcc507063dc2732cfb9f9" data-snippet-saved="false" data-codota-status="done"><strong>Input:</strong> n = 4, connections = [[1,2,3],[3,4,4]]
