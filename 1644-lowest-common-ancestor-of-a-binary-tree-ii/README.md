...
<div class="top-box hide"><div class="alert-info"></div></div><pre data-original-code="Input: root = [3,5,1,6,2,0,8,null,null,7,4], p = 5, q = 1
Output: 3
Explanation: The LCA of nodes 5 and 1 is 3." data-snippet-id="ext.aba8623cd9ded1985336c43dba75bc37" data-snippet-saved="false" data-codota-status="done"><strong>Input:</strong> root = [3,5,1,6,2,0,8,null,null,7,4], p = 5, q = 1
...
<div class="top-box hide"><div class="alert-info"></div></div><pre data-original-code="Input: root = [3,5,1,6,2,0,8,null,null,7,4], p = 5, q = 4
Output: 5
Explanation: The LCA of nodes 5 and 4 is 5. A node can be a descendant of itself according to the definition of LCA." data-snippet-id="ext.af02b5e8189213f5264eadee7d915104" data-snippet-saved="false" data-codota-status="done"><strong>Input:</strong> root = [3,5,1,6,2,0,8,null,null,7,4], p = 5, q = 4
...
<div class="top-box hide"><div class="alert-info"></div></div><pre data-original-code="Input: root = [3,5,1,6,2,0,8,null,null,7,4], p = 5, q = 10
Output: null
Explanation: Node 10 does not exist in the tree, so return null.
" data-snippet-id="ext.e741ec39f1e20b285f1e9e5bc43dc154" data-snippet-saved="false" data-codota-status="done"><strong>Input:</strong> root = [3,5,1,6,2,0,8,null,null,7,4], p = 5, q = 10
